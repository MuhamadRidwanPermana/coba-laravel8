      ...
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item dropdown" style="margin-right: 50px">
          <a class="nav-link nav-icon-hover" href="javascript:void(0)" id="drop2" data-bs-toggle="dropdown"
            aria-expanded="false">
            @if(Auth::user()->image)
              <img src="{{ asset('storage/' . Auth::user()->image) }}" class="rounded-circle img-navbar" width="35" height="35" alt="{{ Auth::user()->name }}">
            @else
              <img src="https://source.unsplash.com/500x500/?person" class="rounded-circle img-navbar" width="35" height="35" alt="{{ Auth::user()->id }}">
            @endif
